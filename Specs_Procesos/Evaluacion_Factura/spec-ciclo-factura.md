...
| ~~**`simularOferta` no emite versión**~~ → **cerrado el 23-09-2026** (ADR-0013, regla 68): simular dispara el evento de evaluación y emite la v1 con las cinco secciones; el recorte por verificación ya no emite (ADR-0018) y el comité emite la suya (ADR-0015) | toda operación simulada tiene versión de la cual leer (caso 168) |
