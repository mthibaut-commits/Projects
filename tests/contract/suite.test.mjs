/* La suite de 139 casos (`tests_asignacion_lineas.js`) corre en Chromium y tarda ~2 min: es el paso 5 de
...
export const CASOS_ESPERADOS = 139;   // snapshot: cambia sólo cuando se agrega o retira un caso a propósito
