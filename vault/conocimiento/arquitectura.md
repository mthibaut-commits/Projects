...
> Verbatim del `CLAUDE.md` anterior al 17-09-2026. Los comandos canónicos están en la tabla de `CLAUDE.md`; acá está el porqué de cada pieza. **Tres cifras de este texto están desfasadas y sin gate** (líneas, componentes y MB del build: ver `Auditorias/Auditoria_Bootstrap_Agentico.md` §2.3); se corrigen cuando exista el gate que las produzca, no a mano.
