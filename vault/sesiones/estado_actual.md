...
(`pipeline_comercial.jsx`), build standalone de 41,1 MB, **141/141 PASA**, **29 archivos de gate de contrato**
(188 tests), **29 casos e2e**, `tsc` limpio, 0 duplicados. El 17-09-2026 el repo abrió su vault (64 reglas
...
`prettier --check` como paso 0 del CI, con los 59 gates de texto que cayeron re-anclados sobre `canonico()`.
...
Últimas: [formateo del fuente](./2026-09-18_formatear_el_fuente.md) · [auditorías y paso 2](./2026-09-18_auditorias_y_paso_2.md) · [deudas cerradas](./2026-09-18_deudas_cerradas.md)
