...
- Clases de fuente propias `t8`–`t13`, `t15` (definidas en el `<style>` del componente; **t14 no existe**). Escala Datamart: t8=11px, t9=10px, t10=11px, t11=12px, t12=13px, t13=14px, t15=16px. Fuente **Geist** (Google Fonts, @import en el `<style>`).
