/* Gate de contrato de la regla 64 (el corte y el reinicio del día son por RELOJ del tenant; al corte la oportunidad sin
...
test("regla 64: el corte y el reinicio son por reloj del tenant, el corte elimina la sin oferta y el reinicio la re-origina con referencia", () => {
