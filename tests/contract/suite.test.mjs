/* La suite de 114 casos (`tests_asignacion_lineas.js`) corre en Chromium y tarda ~2 min: es el paso 5 de
   ...
   conteo es un SNAPSHOT: subirlo es la decisión de haber agregado un caso, no un trámite. */
import test from "node:test";
import assert from "node:assert/strict";
import { leer, numerosDeCasos, casosDeSuite } from "./_comun.mjs";

export const CASOS_ESPERADOS = 114;   // snapshot: cambia sólo cuando se agrega o retira un caso a propósito
