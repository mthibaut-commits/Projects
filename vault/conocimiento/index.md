...
| [`verificacion.md`](./verificacion.md) | ¿Qué cubre cada uno de los 155 casos de la suite y cada paso de verificación? || [`contrato_servidor_y_auditoria.md`](./contrato_servidor_y_auditoria.md) | ¿Qué debe implementar el resolver 1:1, qué es y qué no es un control de seguridad acá, cómo se audita? |
