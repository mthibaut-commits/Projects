...
export function auditarRegla75(src) {
  ...
  if (!can.includes("inhabilitada(s) en el SII: reclamo, nota de crédito o cesión a otro, regla 75")) fallos.push("VER-01 no nombra las inhabilitadas en el SII");
...
const MUTANTES = [
  ...
  ["VER-01 calla", (c) => c.replace("inhabilitada(s) en el SII: reclamo, nota de crédito o cesión a otro, regla 75", "")],
