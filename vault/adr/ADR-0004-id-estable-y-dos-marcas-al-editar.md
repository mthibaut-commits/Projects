---
type: adr
title: "ADR-0004 — El id de la operación es estable, y editar una oferta cerrada usa dos marcas"
...
# ADR-0004: el id es estable, y editar usa dos marcas
...
un chip «Operación creada» y una acción **Editar** que reabra el paquete y re-evalúe todo (regla 33).
...
- Los repositorios por operación sobreviven al cierre del día. Para una oportunidad en prospección están
  ...
  «lo ya excepcionado y vigente conserva su estado» de la regla 33—.
...
- Deuda: la guarda contra una segunda solicitud al comité idéntica compara contra las solicitudes de la
  pestaña que cierra; con la pestaña cerrada en medio entra una segunda (regla 33).
