...
| [ADR-0021](./ADR-0021-la-nc-el-reclamo-o-la-cesion-ajena-sobre-la-oferta-cerrada-inhabilitan-el-documento.md) | Sobre un documento de una oferta cerrada, publicada o firmada, la NC, el reclamo o la cesión a otro lo inhabilitan y dejan la operación no cursable: el veto es el de la regla 67 escrito por el SII, cuenta como pendiente aunque la llamada esté en verde, y el ejecutivo retira, re-evalúa y vuelve a firmar | aceptada · decisión del usuario 23-09-2026 (decisión #7 de `spec-inbound` §12) |
