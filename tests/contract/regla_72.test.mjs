/* Gate de contrato de la regla 72 (M-01, G-01: el acuse del receptor es una bandera del DTE que el A1 trae; `facturaDeDTE`
...
test("regla 72: el acuse del receptor es una bandera del DTE que el A1 trae; facturaDeDTE la lee, la fila la muestra, ningún filtro la mira y nadie la sortea", () => {
