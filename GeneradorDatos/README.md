...
Desde el 23-09-2026 (ADR-0020, regla 70) el bloque `DTESYNC` no es «una fila por documento con su estado final»
...
gate `tests/contract/regla_70.test.mjs` las corre a las dos sobre el mismo log y exige el mismo resultado;
