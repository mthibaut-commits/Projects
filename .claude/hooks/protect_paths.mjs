...
export const PROTEGIDAS = [
  ...
  { re: /(^|\/)(Capturas_UI|Variantes_UI|Capturas_Simuladas)\/[^/]+\.html$/, motivo: "capturas del DOM real, se regeneran con capturar_*.mjs; si una pantalla se ve mal, el arreglo va en el .jsx" },
  { re: /(^|\/)Integraciones\/Integraciones_APIs_y_S3\.md$/, motivo: "lo arma armar_integraciones.mjs desde los doce specs: edita el spec y regenera" },
