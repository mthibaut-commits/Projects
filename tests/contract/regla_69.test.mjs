/* Gate de contrato de la regla 69 (el comité de crédito que rechaza una línea puntual: la API 3 devuelve «Rechazada»
...
test("regla 69: el comité que rechaza retira, versiona y reabre; en cero pierde con causa; «Consultar estados» lo aplica", () => {
