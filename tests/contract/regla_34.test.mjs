/* Gate de contrato de la regla 34 (precedencia del lenguaje visual), sobre el TEXTO del fuente.
...
export const BASE_PALETA = [
  ...
  "#0a7d3f", "#0d9488", "#0e7490", "#0ea5e9", "#0f766e", "#111b21",
  "#115e59", "#128c7e", "#14b8a6", "#166534", "#16a34a", "#1976d2",
  "#1e40af", "#22d3ee", "#230c65", "#232272", "#2563eb", "#25d366",
  "#316094", "#333840", "#334155", "#34b7f1", "#374151", "#4b5563",
  "#4c1d95", "#4f46e5", "#53bdeb", "#58606e", "#5b21b6", "#5b21d6",
  "#5e5e5e", "#64748b", "#667781", "#66ad82", "#6a2e92", "#6b7280",
  "#6d28d9", "#6d5bff", "#703eff", "#7c3a10", "#7c3aed", "#7c7a85",
  "#7f90af", "#7fba00", "#86efac", "#8a63ff", "#8b5cf6", "#92400e",
  ...
  "#edeef1", "#ee2eff", "#eef3ff", "#ef4444", "#efeae2", "#eff6ff",
  "#f0eff3", "#f0fdf4", "#f0fdfa", "#f1ecff", "#f25022", "#f3d8b6",
  "#f3f2f7", "#f3f4f6", "#f5f3ff", "#f5f4f8", "#f5f7fa", "#f7f7fa",
  "#f8fbff", "#f97316", "#f9fafb", "#faf5ff", "#faf9fb", "#fafafb",
  "#fca5a5", "#fcfcfd", "#fdba74", "#fde68a", "#fecaca", "#fed7aa",
  "#fef2f2", "#fef3c7", "#ff814b", "#ffb900", "#fff7ed", "#fffbeb",
  "#ffffff",];
