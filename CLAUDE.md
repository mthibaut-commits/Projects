...
- Clases de fuente propias `t8`–`t13`, `t15` (definidas en el `<style>` del componente; **t14 no existe**).
- Paleta en el objeto `C`: ink #1c1917, sub #78716c, faint #a8a29e, line #ece8e1, page #FAF8F3, indigo #4f46e5, green #16a34a, amber #d97706, red #dc2626, etc.
