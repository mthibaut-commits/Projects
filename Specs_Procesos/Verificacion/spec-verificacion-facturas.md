...
- Si el deudor **no confirma**, la factura queda **marcada «no verificada»** y la operación no se cursa mientras siga en la oferta; el ejecutivo comercial —avisado por mensajería— la retira, vuelve a simular y publica de nuevo para que el cliente firme la nueva operación (regla 70, ADR-0018, 23-09-2026). Antes Security la retiraba sola.
