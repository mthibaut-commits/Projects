...
| M-18 | Deudor bloqueado → el sistema retira sus facturas automáticamente | pendiente → **decidido: implementar**, redefinida en dos mitades: la del **comité** está **implementada el 23-09-2026** (ADR-0015, regla 65, caso 165: el rechazo retira las facturas del deudor, deja versión y reabre para una nueva firma; en cero, pérdida); la de la **verificación** sigue pendiente (ADR-0018: el sistema marca la operación con un issue y avisa; el ejecutivo retira, re-simula y vuelve a publicar) | `rechazoComiteDecision` + `aplicarRechazoComite` (comité); `retirarFacturaOferta`: tres llamadores, todos `"noConfirmada"` y todos disparados por la marca de la verificación (`verificarDeudor`, `marcarFactura`, `noConfirmoDeudor`; el detalle por el diálogo «Retirar factura no confirmada»): hoy retira solo y la operación encoge con la firma vigente (regla 13); `verifResumenDeal` no produce el issue y ningún hilo avisa al ejecutivo |
...
Conteo sobre las 40 cláusulas: **33 implementadas** (14 medidas, ocho implementadas el 23-09-2026 —M-09, ADR-0014; M-10, regla 61; M-19, regla 62; M-33, ADR-0017; M-07 y M-08, ADR-0019; M-29, ADR-0015; M-21, ADR-0016— más 11 por definición ajustada: M-05,
M-06, M-12, M-15, M-20, M-23, M-25, M-27 y M-35 el 22-09-2026, y M-22 y M-28 el 23-09-2026) · **6
implementadas distinto** (M-01, M-02, M-13, M-24, M-26, M-36: las
seis con «decidido: implementar» y ninguna con una pregunta abierta) · **1 pendiente** (M-18, de
máquina de estados, con «decidido: implementar»: su mitad del comité ya está —ADR-0015, regla 65— y la de la
verificación va con ADR-0018) · **0 decisiones abiertas** (la última, M-22, cerrada el 23-09-2026: la
