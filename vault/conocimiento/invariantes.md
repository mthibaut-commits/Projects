...
| 53 | El tab de Verificación se ve con la oferta SIMULADA, en modo informativo (la compuerta protege la llamada, no la información); el chip del deudor dice **Prime** y la nota va rotulada; los criterios V00–V10 son del DEUDOR y el quiz telefónico de la FACTURA | [`reglas/verificacion.md`](./reglas/verificacion.md) | `e2e-53-a`, `e2e-53-b`, `regla_verif_informativa.test.mjs` |
