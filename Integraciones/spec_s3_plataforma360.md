...
|---|---|---|
| **4.0.0** | 23-09-2026 | Los ocho montos pierden el sufijo `_M` y van en **pesos enteros**: en miles quedaban cuantizados de a $1.000. Afecta a `MARGEN_ULT_MES`, `MARGEN_12M`, `COLOC_PROM_12M`, `COMISION_ULT_OP`, `PATRIMONIO`, `GENERACION`, `VENTAS_A1..A3` y `VENTAS_SII_A1..A3`. Quien implementó la entrega en miles debe multiplicar por mil. |
