...
- Una regla **sin área no la aprueba nadie**. Un default silencioso —«si no dice área, que la vea
...
| El **predictor de verificación** sigue mandando al teléfono a casi todos los pares, y ya no por las unidades: **V04** compara la operación contra una venta mensual que el A10 deriva de una ventana de 47 días con ~2 facturas por par —una sola factura ya supera el «promedio mensual»— y **V10** exige MM$1.000 pagados en 3 meses | con una sola factura en la oferta, V04 lo pasa el 28% de los pares PRIME y el 1% de OTROS; V10, el 15% y el 5%. Quedan «verificados por modelo» el 5,3% de los pares PRIME y ninguno de OTROS, así que **Giro Express es alcanzable pero raro**. Es una propiedad del dato generado y del umbral de política, no del motor |
...
| Documento | Qué cubre |
|---|---|
| `Specs_Procesos/spec-inbound-facturas.md` | ① — qué facturas entran y cuáles abren oportunidad |
| `Specs_Procesos/spec-asignacion-lineas.md` | ③a — las cinco líneas, los tres niveles, la cascada |
| `Specs_Procesos/spec-otorgamiento.md` | ③b — el catálogo, la atribución y el motor como servicio |
| `Specs_Procesos/spec-verificacion-facturas.md` | ③c — los dos protocolos y los diez criterios |
...
| `Inconsistencias_Motor_Otorgamiento.md` | la auditoría de la política contra el motor, con sus decisiones de negocio |
