...
## Reglas de dominio (62 · 41 con caso en la suite —32 lo citan en su texto, 9 se les asignó por el título del caso— · 21 sólo por revisión)
...
| 32 | Cerrada la oferta, el CTA se va y queda «Operación creada» + Acciones › Editar | [`reglas/curse_firma_y_etapas.md`](./reglas/curse_firma_y_etapas.md) | 116 |
