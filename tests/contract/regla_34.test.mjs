// -------------------------------------------------------------------------------------------------
// Gate de la regla 34 — el arte de la portada es un activo GENERADO, y los dos builds lo embeben.
//
...
test("regla 34: los DOS builds leen arte_login.js y lo agregan al payload", () => {
...
test("regla 34: el generador existe y sale de Capturas_UI, no de una maqueta", () => {
...
test("regla 34: el fuente degrada si el activo falta, en vez de romper", () => {
