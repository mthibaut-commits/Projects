...
| **Reevaluación tras el contacto** | Si el deudor confirma solo parte de las facturas y Security retira el resto, el monto de la operación baja y podrían cambiar tanto la asignación de línea como el propio resultado de verificación. Falta definir si se recalcula o el resultado del contacto congela la decisión. |
