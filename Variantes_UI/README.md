...
**`tubo-tabla-simulada` ya no vive acá**: es una captura del **tubo**, no un estado del detalle, y se
mudó a `Capturas_Simuladas/` el 21-09-2026. Estaba en esta carpeta sólo porque se llega igual —armando
la oferta en el detalle—, y ese parecido de procedimiento escondía que son dos cosas distintas.
