...
| **V03_MNT_COMPRA_3M_M** | V03 | razón ≤ 1,3× | **Total comprado al par en 3M móviles (M$).** NEX divide el monto de la operación con ese deudor por este total. El archivo trae el **total**, no la razón: la razón depende de la operación que se está evaluando y el archivo no la conoce |
