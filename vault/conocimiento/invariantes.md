...
## Reglas de dominio (63 · todas con gate desde el 17-09-2026: 41 tenían caso en la suite —32 lo citan en su texto, 9 se les asignó por el título del caso—, la 32 tiene el suyo de contrato, y las 21 que iban sólo por revisión recibieron el suyo en la suite, en `tests/e2e/` o en `tests/contract/`)
